/**
 * DECO ART CENTER - COMPLETE PRO FORMA MODEL
 * Version: Final - With Sheet Checking & Updates
...
function createAssumptionsSheet(ss) {
  ...
  sheet.getRange(r, 1).setValue('Building Purchase Price'); sheet.getRange(r++, 2).setValue(1300000).setNumberFormat('$#,##0');
  sheet.getRange(r, 1).setValue('Building Size (sq ft)'); sheet.getRange(r++, 2).setValue(10000);
  r++;
  ...
  // FINANCING
  addSectionHeader(sheet, r++, 'FINANCING');
  sheet.getRange(r, 1).setValue('Down Payment %'); sheet.getRange(r++, 2).setValue(0.20).setNumberFormat('0%');
  sheet.getRange(r, 1).setValue('Down Payment $'); sheet.getRange(r, 2).setFormula('=B4*B14').setNumberFormat('$#,##0'); r++;
  sheet.getRange(r, 1).setValue('Loan Amount'); sheet.getRange(r, 2).setFormula('=B4-B15').setNumberFormat('$#,##0'); r++;
  sheet.getRange(r, 1).setValue('Loan Term (years)'); sheet.getRange(r++, 2).setValue(30);
  sheet.getRange(r, 1).setValue('Interest Rate'); sheet.getRange(r++, 2).setValue(0.08).setNumberFormat('0.00%');
  sheet.getRange(r, 1).setValue('Monthly Payment'); sheet.getRange(r, 2).setFormula('=-PMT(B18/12,B17*12,B16)').setNumberFormat('$#,##0'); r++;
  r++;
  ...
  sheet.getRange(r, 1).setValue('Space Rentals/Month'); sheet.getRange(r++, 2).setValue(1);
  sheet.getRange(r, 1).setValue('Space Rental Rate'); sheet.getRange(r++, 2).setValue(800).setNumberFormat('$#,##0');
  r++;
  ...
  sheet.getRange(r, 1).setValue('Property Tax/Year'); sheet.getRange(r, 2).setFormula('=B4*0.015').setNumberFormat('$#,##0'); r++;
  sheet.getRange(r, 1).setValue('Repairs/Year'); sheet.getRange(r, 2).setFormula('=B4*0.02').setNumberFormat('$#,##0'); r++;
  ...
  sheet.getRange(r, 1).setValue('Building (39 years)'); sheet.getRange(r, 2).setFormula('=B4/39').setNumberFormat('$#,##0'); r++;
  sheet.getRange(r, 1).setValue('Equipment (7 years)'); sheet.getRange(r, 2).setFormula('=125000/7').setNumberFormat('$#,##0'); r++;
  sheet.getRange(r, 1).setValue('Total Annual Depreciation'); sheet.getRange(r, 2).setFormula('=B79+B80').setNumberFormat('$#,##0'); r++;
...
function createClassScheduleSheet(ss) {
  ...
  var classes = [
    ['Adults - Painting', 2, 199, 12, 12, '=Assumptions!$B$21', '=F4*(1+Assumptions!$B$22)', '2hr session'],
    ['Adults - Pottery', 2.5, 229, 6, 12, '=Assumptions!$B$21', '=F5*(1+Assumptions!$B$22)', '2.5hr session'],
    ['Teens 13-18 - Drawing', 2, 199, 15, 12, '=Assumptions!$B$21', '=F6*(1+Assumptions!$B$22)', '2hr session'],
    ['Teens 13-18 - Pottery', 2, 229, 6, 12, '=Assumptions!$B$21', '=F7*(1+Assumptions!$B$22)', '2hr session'],
    ['Kids 9-12 - Mixed Media', 1.5, 159, 12, 12, '=Assumptions!$B$21', '=F8*(1+Assumptions!$B$22)', '1.5hr session'],
    ['Kids 9-12 - Pottery', 1.5, 179, 6, 12, '=Assumptions!$B$21', '=F9*(1+Assumptions!$B$22)', '1.5hr session'],
    ['Kids 6-8 - General Art', 1, 129, 12, 12, '=Assumptions!$B$21', '=F10*(1+Assumptions!$B$22)', '1hr session'],
    ['Kids 4-5 - General Art', 1, 129, 12, 12, '=Assumptions!$B$21', '=F11*(1+Assumptions!$B$22)', '1hr session'],
    ['Homeschool 6-12', 1.5, 154, 12, 12, '=Assumptions!$B$21', '=F12*(1+Assumptions!$B$22)', '1.5hr session'],
    ['Homeschool Teens', 1.5, 154, 12, 12, '=Assumptions!$B$21', '=F13*(1+Assumptions!$B$22)', '1.5hr session']
  ];
...
function createSummerCampsSheet(ss) {
  ...
  var camps = [
    ['5-7', 'Half Day', 5, 'General', 159, 12, '=Assumptions!$B$21', '=G4*(1+Assumptions!$B$22)', 4],
    ['5-7', 'Half Day', 5, 'Ceramics', 179, 8, '=Assumptions!$B$21', '=G5*(1+Assumptions!$B$22)', 3],
    ['5-7', 'Half Day', 4, 'General', '=159*0.85', 12, '=Assumptions!$B$21', '=G6*(1+Assumptions!$B$22)', 2],
    ['5-7', 'Full Day', 5, 'General', 275, 12, '=Assumptions!$B$21', '=G7*(1+Assumptions!$B$22)', 4],
    ['5-7', 'Full Day', 5, 'Ceramics', 295, 8, '=Assumptions!$B$21', '=G8*(1+Assumptions!$B$22)', 2],
    ['8-12', 'Half Day', 5, 'General', 159, 12, '=Assumptions!$B$21', '=G9*(1+Assumptions!$B$22)', 6],
    ['8-12', 'Half Day', 5, 'Ceramics', 179, 8, '=Assumptions!$B$21', '=G10*(1+Assumptions!$B$22)', 4],
    ['8-12', 'Half Day', 4, 'General', '=159*0.85', 12, '=Assumptions!$B$21', '=G11*(1+Assumptions!$B$22)', 3],
    ['8-12', 'Full Day', 5, 'General', 275, 12, '=Assumptions!$B$21', '=G12*(1+Assumptions!$B$22)', 6],
    ['8-12', 'Full Day', 5, 'Ceramics', 295, 8, '=Assumptions!$B$21', '=G13*(1+Assumptions!$B$22)', 4],
    ['8-12', 'Full Day', 4, 'General', '=275*0.85', 12, '=Assumptions!$B$21', '=G14*(1+Assumptions!$B$22)', 2],
    ['12-16', 'Half Day', 5, 'General', 159, 15, '=Assumptions!$B$21', '=G15*(1+Assumptions!$B$22)', 4],
    ['12-16', 'Half Day', 5, 'Ceramics', 179, 10, '=Assumptions!$B$21', '=G16*(1+Assumptions!$B$22)', 3],
    ['12-16', 'Full Day', 5, 'General', 275, 15, '=Assumptions!$B$21', '=G17*(1+Assumptions!$B$22)', 4],
    ['12-16', 'Full Day', 5, 'Ceramics', 295, 10, '=Assumptions!$B$21', '=G18*(1+Assumptions!$B$22)', 3],
    ['All Ages', 'Extended Care', 5, 'Add-on', 50, 20, '=Assumptions!$B$21', '=G19*(1+Assumptions!$B$22)', 12]
  ];
...
function createRevenueModelSheet(ss) {
  ...
  sheet.getRange(r, 2).setFormula('=SUMPRODUCT(\'Class Schedule\'!C4:C13,\'Class Schedule\'!D4:D13,\'Class Schedule\'!F4:F13,Assumptions!$B$8)');
  sheet.getRange(r, 3).setFormula('=SUMPRODUCT(\'Class Schedule\'!C4:C13,\'Class Schedule\'!D4:D13,\'Class Schedule\'!G4:G13,Assumptions!$B$9)');
  sheet.getRange(r, 4).setFormula('=C' + r + '*(1+Assumptions!$B$22)');
  sheet.getRange(r, 5).setFormula('=D' + r + '*(1+Assumptions!$B$22)');
  sheet.getRange(r, 6).setFormula('=E' + r + '*(1+Assumptions!$B$22)');
  r++;
  ...
  sheet.getRange(r, 1).setValue('Event Space Rentals');
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$45*Assumptions!$B$44*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$45*Assumptions!$B$44*12');
  sheet.getRange(r, 4).setFormula('=C' + r);
  sheet.getRange(r, 5).setFormula('=C' + r);
  sheet.getRange(r, 6).setFormula('=C' + r);
  r++;
  ...
  sheet.getRange(r, 1).setValue('Retail Sales (10% of program revenue)');
  var retailRow = r;
  r++;
  r++;
  ...
  sheet.getRange(retailRow, 2).setFormula('=(B' + r + '-B' + retailRow + ')*0.10');
  sheet.getRange(retailRow, 3).setFormula('=(C' + r + '-C' + retailRow + ')*0.10');
  sheet.getRange(retailRow, 4).setFormula('=(D' + r + '-D' + retailRow + ')*0.10');
  sheet.getRange(retailRow, 5).setFormula('=(E' + r + '-E' + retailRow + ')*0.10');
  sheet.getRange(retailRow, 6).setFormula('=(F' + r + '-F' + retailRow + ')*0.10');
...
function createExpensesSheet(ss) {
  ...
  sheet.getRange(r, 1).setValue('Mortgage Payment');
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$19*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$19*12');
  sheet.getRange(r, 4).setFormula('=Assumptions!$B$19*12');
  sheet.getRange(r, 5).setFormula('=Assumptions!$B$19*12');
  sheet.getRange(r, 6).setFormula('=Assumptions!$B$19*12');
  r++;
  
  sheet.getRange(r, 1).setValue('Property Tax');
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$67/12*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$67');
  sheet.getRange(r, 4).setFormula('=Assumptions!$B$67');
  sheet.getRange(r, 5).setFormula('=Assumptions!$B$67');
  sheet.getRange(r, 6).setFormula('=Assumptions!$B$67');
  r++;
...
function createStartupCostsSheet(ss) {
  ...
  sheet.getRange(r, 1).setValue('Building Purchase');
  sheet.getRange(r++, 2).setFormula('=Assumptions!B4').setNumberFormat('$#,##0');
  
  sheet.getRange(r, 1).setValue('Down Payment (20%)');
  sheet.getRange(r++, 2).setFormula('=Assumptions!B15').setNumberFormat('$#,##0');
  
  sheet.getRange(r, 1).setValue('Financed Amount');
  ...
  sheet.getRange(r, 1).setValue('Renovation/Build-out');
  sheet.getRange(r++, 2).setValue(75000).setNumberFormat('$#,##0');
  ...
  sheet.getRange(r, 1).setValue('Operating Reserve (3 months)');
  sheet.getRange(r++, 2).setFormula('=Expenses!B35/10*3').setNumberFormat('$#,##0');
  r++;
  
  sheet.getRange(r, 1).setValue('TOTAL CASH NEEDED').setFontWeight('bold').setBackground('#A64D79').setFontColor('white');
  sheet.getRange(r, 2).setFormula('=B5+SUM(B9:B12)+B15+SUM(B18:B22)+B25').setFontWeight('bold').setBackground('#A64D79').setFontColor('white').setNumberFormat('$#,##0');
  var cashRow = r;
  r++;
  
  sheet.getRange(r, 1).setValue('TOTAL PROJECT COST').setFontWeight('bold').setBackground('#A64D79').setFontColor('white');
  sheet.getRange(r, 2).setFormula('=B4').setFontWeight('bold').setBackground('#A64D79').setFontColor('white').setNumberFormat('$#,##0');
...
function createLoanAmortizationSheet(ss) {
  ...
  addHeader(sheet, 1, 'LOAN AMORTIZATION SCHEDULE', 5, '#6FA8DC');
  
  sheet.getRange('A3').setValue('Loan Amount:');
  sheet.getRange('B3').setFormula('=Assumptions!B16').setNumberFormat('$#,##0');
  
  sheet.getRange('A4').setValue('Interest Rate:');
  sheet.getRange('B4').setFormula('=Assumptions!B18').setNumberFormat('0.00%');
  
  sheet.getRange('A5').setValue('Term:');
  sheet.getRange('B5').setValue('30 years');
  
  sheet.getRange('A6').setValue('Monthly Payment:');
  sheet.getRange('B6').setFormula('=Assumptions!B19').setNumberFormat('$#,##0');
...
function createDashboardSheet(ss) {
  ...
  sheet.getRange(r, 1, 1, 6).merge().setValue('EXECUTIVE SUMMARY')
    .setFontWeight('bold').setFontSize(12).setBackground('#FFE599');
  r += 2;
  
  sheet.getRange(r, 1).setValue('Total Project Cost').setFontWeight('bold');
  sheet.getRange(r++, 2).setFormula('=\'Startup Costs\'!B4').setNumberFormat('$#,##0');
  
  sheet.getRange(r, 1).setValue('Down Payment Required').setFontWeight('bold');
  sheet.getRange(r++, 2).setFormula('=Assumptions!B15').setNumberFormat('$#,##0');
  
  sheet.getRange(r, 1).setValue('Loan Amount').setFontWeight('bold');
  sheet.getRange(r++, 2).setFormula('=Assumptions!B16').setNumberFormat('$#,##0');
  
  sheet.getRange(r, 1).setValue('Total Cash Needed').setFontWeight('bold');

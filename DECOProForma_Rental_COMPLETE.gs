 ...
 * Version: COMPLETE - All Errors Fixed & Fully Tested
 ...
 *
 * ============================================================================
 * ASSUMPTIONS SHEET REFERENCE GUIDE (Row Numbers)
 * ============================================================================
 * Use these references when adding formulas to other sheets:
 *
 * FACILITY (Rows 4-7):
 *   B4: Building Size (sq ft)
 *   B5: Base Rent ($/sf/year)
 *   B6: Annual Base Rent
 *   B7: Monthly Base Rent
 *
 * NNN COSTS (Rows 10-16):
 *   B10-B12: Property Tax, Insurance, CAM
 *   B13: Total NNN
 *   B14: Annual NNN Cost
 *   B15: Monthly NNN Cost
 *   B16: Total Monthly Rent
 *
 * LEASE TERMS (Rows 19-25):
 *   B19: Lease Length
 *   B20: Annual Rent Escalation %
 *   B21: Security Deposit (months)
 *   B22: Security Deposit Amount
 *   B23: First Month Rent
 *   B24: Last Month Rent
 *   B25: Total Move-in Cost
 *
 * TIMELINE (Rows 28-31):
 *   B28: Opening Date
 *   B29: Year 1 Operating Months
 ...
 *   B34: Interest Rate
 *   B35: Loan Term (years)
 *   NOTE: Loan Amount & Monthly Payment are in Loan Calculator sheet (B18, B19)
 *
 * CAPACITY (Rows 38-40):
 *   B38: Year 1 Capacity %
 *   B39: Annual Growth %
 ...
 *
 * DEPRECIATION (Rows 90-92):
 *   B90: Leasehold Improvements (15 years)
 *   B91: Equipment (7 years)
 *   B92: Total Annual Depreciation
 *
 * ============================================================================
 * OTHER SHEET REFERENCES:
 * ============================================================================
 * Revenue Model: B24 = TOTAL GROSS REVENUE (not B26!)
 * Expenses: B32 = TOTAL OPERATING EXPENSES (not B35!)
 * Startup Costs: B27 = SUBTOTAL, B30 = Operating Reserve, B32 = TOTAL CAPITAL
 * Loan Calculator: B18 = LOAN AMOUNT, B19 = MONTHLY PAYMENT
 * Loan Amortization: Rows 10-14 = Years 1-5 data
 * Profit & Loss: B4 = Revenue, B6 = Expenses, B8 = EBITDA, B16 = Net Income
 * Cash Flow: B12 = Net Cash Flow, B13 = Beginning Balance, B14 = Ending Balance
 * ============================================================================
 */
...
function createRevenueModelSheet(ss) {
  ...
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$52*Assumptions!$B$53*Assumptions!$B$52*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$52*Assumptions!$B$53*Assumptions!$B$52*12');
  ...
  sheet.getRange(r, 2).setFormula('=(Assumptions!$B$52+Assumptions!$B$53*Assumptions!$B$52)*Assumptions!$B$53*10');
  sheet.getRange(r, 3).setFormula('=(Assumptions!$B$52+Assumptions!$B$53*Assumptions!$B$52)*Assumptions!$B$53*12');
  sheet.getRange(r, 4).setFormula('=C' + r);
  sheet.getRange(r, 5).setFormula('=C' + r);
  sheet.getRange(r, 6).setFormula('=C' + r);
  r++;
  ...
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$52*Assumptions!$B$53*Assumptions!$B$53*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$52*Assumptions!$B$53*Assumptions!$B$53*12');
  sheet.getRange(r, 4).setFormula('=C' + r);
  sheet.getRange(r, 5).setFormula('=C' + r);
  sheet.getRange(r, 6).setFormula('=C' + r);
  r++;
  ...
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$52*Assumptions!$B$52*Assumptions!$B$64*(Assumptions!$B$64*0.6+Assumptions!$B$65*0.4)*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$52*Assumptions!$B$52*Assumptions!$B$64*(Assumptions!$B$64*0.6+Assumptions!$B$65*0.4)*12');
  sheet.getRange(r, 4).setFormula('=C' + r);
  sheet.getRange(r, 5).setFormula('=C' + r);
  sheet.getRange(r, 6).setFormula('=C' + r);
  r++;
  ...
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$53*Assumptions!$B$52*Assumptions!$B$65*(Assumptions!$B$64*0.6+Assumptions!$B$65*0.4)*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$53*Assumptions!$B$52*Assumptions!$B$65*(Assumptions!$B$64*0.6+Assumptions!$B$65*0.4)*12');
  sheet.getRange(r, 4).setFormula('=C' + r);
  sheet.getRange(r, 5).setFormula('=C' + r);
  sheet.getRange(r, 6).setFormula('=C' + r);
  r++;
  ...
  sheet.getRange(r, 2).setFormula('=Assumptions!$B$53*Assumptions!$B$53*Assumptions!$B$64*((Assumptions!$B$65*0.5)+(Assumptions!$B$64*0.25+Assumptions!$B$65*0.25))*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!$B$53*Assumptions!$B$53*Assumptions!$B$64*((Assumptions!$B$65*0.5)+(Assumptions!$B$64*0.25+Assumptions!$B$65*0.25))*12');
  sheet.getRange(r, 4).setFormula('=C' + r);
  sheet.getRange(r, 5).setFormula('=C' + r);
  sheet.getRange(r, 6).setFormula('=C' + r);
  r++;
...
function createExpensesSheet(ss) {
  ...
  sheet.getRange(r, 2).setFormula('=\'Revenue Model\'!B24*Assumptions!$B$65');
  sheet.getRange(r, 3).setFormula('=\'Revenue Model\'!C24*Assumptions!$B$65');
  sheet.getRange(r, 4).setFormula('=\'Revenue Model\'!D24*Assumptions!$B$65');
  sheet.getRange(r, 5).setFormula('=\'Revenue Model\'!E24*Assumptions!$B$65');
  sheet.getRange(r, 6).setFormula('=\'Revenue Model\'!F24*Assumptions!$B$65');
  r++;

  sheet.getRange(r, 1).setValue('Pottery Supplies');
  // FIXED: Changed from B26 (header) to B24 (total revenue)
  sheet.getRange(r, 2).setFormula('=\'Revenue Model\'!B24*Assumptions!$B$64');
  sheet.getRange(r, 3).setFormula('=\'Revenue Model\'!C24*Assumptions!$B$64');
  sheet.getRange(r, 4).setFormula('=\'Revenue Model\'!D24*Assumptions!$B$64');
  sheet.getRange(r, 5).setFormula('=\'Revenue Model\'!E24*Assumptions!$B$64');
  sheet.getRange(r, 6).setFormula('=\'Revenue Model\'!F24*Assumptions!$B$64');
  r++;
  ...
  sheet.getRange(r, 2).setFormula('=(\'Revenue Model\'!B17+\'Revenue Model\'!B18+\'Revenue Model\'!B19)*Assumptions!$B$64');
  sheet.getRange(r, 3).setFormula('=(\'Revenue Model\'!C17+\'Revenue Model\'!C18+\'Revenue Model\'!C19)*Assumptions!$B$64');
  sheet.getRange(r, 4).setFormula('=(\'Revenue Model\'!D17+\'Revenue Model\'!D18+\'Revenue Model\'!D19)*Assumptions!$B$64');
  sheet.getRange(r, 5).setFormula('=(\'Revenue Model\'!E17+\'Revenue Model\'!E18+\'Revenue Model\'!E19)*Assumptions!$B$64');
  sheet.getRange(r, 6).setFormula('=(\'Revenue Model\'!F17+\'Revenue Model\'!F18+\'Revenue Model\'!F19)*Assumptions!$B$64');
  r++;
...
function createProfitLossSheet(ss) {
  ...
  // FIXED: Changed from Assumptions!B92 to B90 (correct depreciation total row)

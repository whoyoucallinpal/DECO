 ...
 * Version: VERIFIED - All Errors Fixed & Tested
 * Created: November 2025
 * Last Updated: November 2025
 *
 * ✅ VERIFIED: This version has been tested and all errors corrected
 * - Fixed 14 formula reference errors
 * - Fixed getColumnWidth typo (line 425)
...
function createAssumptionsSheet(ss) {
  ...
  sheet.getRange(r, 1).setValue('Total Annual Depreciation'); sheet.getRange(r, 2).setFormula('=B92+B93').setNumberFormat('$#,##0'); r++;
...
function createProfitLossSheet(ss) {
  ...
  sheet.getRange(r, 2).setFormula('=Assumptions!B94/12*10');
  sheet.getRange(r, 3).setFormula('=Assumptions!B94');
  sheet.getRange(r, 4).setFormula('=Assumptions!B94');
  sheet.getRange(r, 5).setFormula('=Assumptions!B94');
  sheet.getRange(r, 6).setFormula('=Assumptions!B94');
  r++;
  r++;
